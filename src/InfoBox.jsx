...
export default function InfoBox({info}){
      ...
      const RAIN_URL ="https://as2.ftcdn.net/v2/jpg/01/63/96/63/1000_F_163966311_qh3qSk57mw9oLPOklZigzX9zlB5DgdaM.jpg";
      ...
      return(
            <div className="InfoBox">
                  ...
                  <Card sx={{ maxWidth: 345 }}> 
                        ...
                        {info.city}<>{" "}{info.humidity>65?<ThunderstormIcon/>: info.temp>20?<LightModeIcon/>:<AcUnitIcon/>}</>
                        </Typography>
